export interface ElementalField {
...
export interface TerrainTypeInterface {
  ...
  "./image/Ryuutama/Terrain/Ryuutama_Deep_Forest.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Desert.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Grassland.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Highlands.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Jungle.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Mountain.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Rocky_Terrain.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Swamp.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Wasteland.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Woodland.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Village.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Town.png" |
  "./image/Ryuutama/Terrain/Ryuutama_City.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Large_City.png",
}

export type TerrainTypeOptions = 
  "./image/Ryuutama/Terrain/Ryuutama_Alpine.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Deep_Forest.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Desert.png" |
  "./image/Ryuutama/Terrain/Ryuutama_Grassland.png" |
