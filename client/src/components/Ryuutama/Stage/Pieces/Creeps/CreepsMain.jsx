...
function Creeps(props) {
    ...
    var allCards = props.fullDataCreeps.map(function (singleCard, index) {
        return (<CreepsSingleCard_jsx_1.CreepsSingleCard creepInfo={singleCard} key={singleCard.name} index={index} fullDataCreeps={props.fullDataCreeps} setFullDataCreeps={props.setFullDataCreeps}/>);
    });
    return (<>
      <div> Freeps </div>
      {allCards}
